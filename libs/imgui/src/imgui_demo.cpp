...
ImGui::ShowDemoWindow(bool* p_open)
{
  ...
  if (ImGui::BeginMenuBar()) {
    ...
    if (ImGui::BeginMenu("Examples")) {
      ...
      ImGui::MenuItem(
        "Constrained-resizing window", nullptr, &show_app_constrained_resize);
  ...
  if (ImGui::TreeNode("Selectables")) {
    ...
    if (ImGui::TreeNode("Grid")) {
      ...
      const bool winning_state = memchr(selected, 0, sizeof(selected)) ==
                                 nullptr; // If all cells are selected...
      if (winning_state)
  ...
  if (ImGui::TreeNode("Text Input")) {
    ...
    if (ImGui::TreeNode("Resize Callback")) {
      ...
      struct Funcs
      {
        ...
        static auto MyInputTextMultiline(const char* label,
...
// natural type maximum, hence the /2.
    ...
    ImGui::InputScalar("input s8",
                       ImGuiDataType_S8,
                       &s8_v,
                       inputs_step ? &s8_one : nullptr,
                       nullptr,
                       "%d");
    ImGui::InputScalar("input u8",
                       ImGuiDataType_U8,
                       &u8_v,
                       inputs_step ? &u8_one : nullptr,
                       nullptr,
                       "%u");
    ImGui::InputScalar("input s16",
                       ImGuiDataType_S16,
                       &s16_v,
                       inputs_step ? &s16_one : nullptr,
                       nullptr,
                       "%d");
    ImGui::InputScalar("input u16",
                       ImGuiDataType_U16,
                       &u16_v,
                       inputs_step ? &u16_one : nullptr,
                       nullptr,
                       "%u");
    ...
    ImGui::InputScalar("input u32 hex",
                       ...
                       ImGuiInputTextFlags_CharsHexadecimal);
    ImGui::InputScalar(
      "input s64", ImGuiDataType_S64, &s64_v, inputs_step ? &s64_one : nullptr);
    ImGui::InputScalar(
      "input u64", ImGuiDataType_U64, &u64_v, inputs_step ? &u64_one : nullptr);
...
ShowDemoWindowLayout()
{
  ...
  if (ImGui::TreeNode("Groups")) {
    ...
    ImGui::PlotHistogram(
      "##values", values, IM_ARRAYSIZE(values), 0, nullptr, 0.0f, 1.0f, size);
  ...
  if (ImGui::TreeNode("Scrolling")) {
    ...
    if (show_horizontal_contents_size_demo_window) {
      ...
      HelpMarker(
        "Test of different widgets react and impact the work rectangle growing "
...
ShowDemoWindowPopups()
{
  ...
  if (ImGui::TreeNode("Modals")) {
    ...
    if (ImGui::BeginPopupModal(
          "Stacked 1", nullptr, ImGuiWindowFlags_MenuBar)) {
      if (ImGui::BeginMenuBar()) {
...
EditTableColumnsFlags(ImGuiTableColumnFlags* p_flags)
{
  ...
  if (ImGui::CheckboxFlags(
        "_WidthAutoResize", p_flags, ImGuiTableColumnFlags_WidthAutoResize))
...
ShowDemoWindowTables()
{
  ...
  if (ImGui::TreeNode("Reorderable, hideable, with headers")) {
    ...
    if (ImGui::BeginTable(
          "##table2", 3, flags | ImGuiTableFlags_ColumnsWidthFixed)) {
      ImGui::TableSetupColumn("One");
      ImGui::TableSetupColumn("Two");
      ImGui::TableSetupColumn("Three");
      ImGui::TableHeadersRow();
  ...
  if (ImGui::TreeNode("Sizing policies, cell contents")) {
    ...
    if (ImGui::CheckboxFlags("ImGuiTableFlags_ColumnsWidthStretch",
      ...
      flags &=
        ~ImGuiTableFlags_ColumnsWidthFixed; // Can't specify both sizing polices
                                            // so we clear the other
    ImGui::SameLine();
    ...
    HelpMarker(
      ...
      "using Stretch columns + ScrollX together doesn't make sense.");
    ...
    ImGui::PushID("flags3");
    ImGui::CheckboxFlags(
      "ImGuiTableFlags_ScrollX", &flags3, ImGuiTableFlags_ScrollX);
    if (ImGui::CheckboxFlags("ImGuiTableFlags_ColumnsWidthStretch",
                             &flags3,
                             ImGuiTableFlags_ColumnsWidthStretch))
      flags3 &=
  ...
  if (ImGui::TreeNode("Row height")) {
    HelpMarker(
      ...
      "2.0f'.\n\nWe cannot honor a _maximum_ row height as that would requires "
      "a unique clipping rectangle per row.");
  ...
  if (ImGui::TreeNode("Sorting")) {
    ...
    if (ImGui::BeginTable(
          "##table", 4, flags, ImVec2(0, TEXT_BASE_HEIGHT * 15), 0.0f)) {
      // Declare columns
...
auto
ImGui::ShowStyleSelector(const char* label) -> bool
{
  ...
  if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None)) {
    ...
    if (ImGui::BeginTabItem("Fonts")) {
      ...
      HelpMarker(
        ...
        "your font at the designed size, "
    ...
    if (ImGui::BeginTabItem("Rendering")) {
      ...
      if (ImGui::IsItemActive()) {
        ...
        for (int n = 0; n < 7; n++) {
          ...
          draw_list->AddCircle(ImVec2(p.x + off_x + rad, p.y + RAD_MAX),
                               rad,
...
struct MyDocument
{
  ...
  explicit MyDocument(const char* name,
                      bool open = true,
...
ShowExampleAppDocuments(bool* p_open)
{
  ...
  if (ImGui::BeginMenuBar()) {
    if (ImGui::BeginMenu("File")) {
      ...
      if (ImGui::MenuItem(
            "Close All Documents", nullptr, false, open_count > 0))
        for (int doc_n = 0; doc_n < app.Documents.Size; doc_n++)
