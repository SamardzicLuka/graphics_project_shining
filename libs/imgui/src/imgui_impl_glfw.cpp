...
static auto
ImGui_ImplGlfw_GetClipboardText(void* user_data) -> const char*
{
...
auto
ImGui_ImplGlfw_InitForOpenGL(GLFWwindow* window, bool install_callbacks) -> bool
{
  return ImGui_ImplGlfw_Init(window, install_callbacks, GlfwClientApi_OpenGL);
}

auto
ImGui_ImplGlfw_InitForVulkan(GLFWwindow* window, bool install_callbacks) -> bool
{
